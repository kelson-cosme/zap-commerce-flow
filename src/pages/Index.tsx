...
import { MessageSquare, BarChart3, LogOut, Loader2, Shield } from "lucide-react";
...
const handleSendMessage = async (text: string) => {
  if (!session || !profile) { // Verificação crucial
      toast({ title: "Erro de Autenticação", description: "A sua sessão expirou. Por favor, faça login novamente.", variant: "destructive" });
        ...
        <div className="flex flex-col h-full">
          ...
          <div className="p-4 border-t">
            {profile?.is_super_admin && (
                <Button variant="destructive" onClick={() => navigate('/super-admin')} className="w-full justify-start mb-2">
